...
if (localStorage.getItem("blogbg") != undefined) {
  ...
  document.getElementById("defineBg").innerText = `:root{
    --default-bg: url(https://towerdance.oss-cn-shanghai.aliyuncs.com/xyz/MeIoN_p1.jpg);
    --darkmode-bg:url(https://towerdance.oss-cn-shanghai.aliyuncs.com/xyz/MeIoN_p0.jpg);
    --mobileday-bg: url(https://towerdance.oss-cn-shanghai.aliyuncs.com/xyz/MeIoN_p4.jpg);
    --mobilenight-bg: url(https://towerdance.oss-cn-shanghai.aliyuncs.com/xyz/MeIoN_p3.jpg);
  }`;
}
// 切换背景主函数
function changeBg(s) {
